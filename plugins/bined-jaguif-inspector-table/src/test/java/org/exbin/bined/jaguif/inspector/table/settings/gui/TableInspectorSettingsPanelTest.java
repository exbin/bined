 ...
 */
package org.exbin.bined.jaguif.inspector.table.settings.gui;
...
/**
 * Test for TableInspectorSettingsPanel.
 */
public class TableInspectorSettingsPanelTest {
    ...
    public void testPanel() {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.wrapInWindow(new TableInspectorSettingsPanel());
        });
    }
}
