...
public class CopyAsAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        ResourceBundle panelResourceBundle = App.getModule(LanguageModuleApi.class).getResourceBundleByBundleName("org.exbin.bined.jaguif.operation.method.gui.resources.CopyAsDataControlPanel");
