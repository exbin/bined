...
public class CompressionDataPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        compressRadioButton.setSelected(true);
        compressRadioButton.setText(bundle.getString("compressRadioButton.text")); // NOI18N
        ...
        decompressRadioButton.setText(bundle.getString("decompressRadioButton.text")); // NOI18N
        ...
        algorithmLabel.setText(bundle.getString("algorithmLabel.text")); // NOI18N

        algorithmComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "algorithm.gzip", "algorithm.zip", "algorithm.deflate" }));
        ...
        autoDetectCheckBox.setSelected(true);
        autoDetectCheckBox.setText(bundle.getString("autoDetectCheckBox.text")); // NOI18N
        ...
        statisticsPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("statisticsPanel.title"))); // NOI18N
