...
/**
 * Stop makro recording action.
 *
 * @author ExBin Project (https://exbin.org)
 */
@ParametersAreNonnullByDefault
public class StopMakroRecordingAction extends AbstractAction {

    public static final String ACTION_ID = "stopMakroRecordingAction";
    ...
    public StopMakroRecordingAction() {
    }
