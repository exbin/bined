 ...
 */
package org.exbin.bined.jaguif.document.settings.gui;
...
/**
 * Test for CodeAreaFileProcessingSettingsPanel.
 */
public class CodeAreaFileProcessingSettingsPanelTest {
    ...
    public void testPanel() {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.wrapInWindow(new CodeAreaFileProcessingSettingsPanel());
        });
    }
}
