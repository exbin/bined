 ...
 */
package org.exbin.framework.bined.launcher.options.gui;
...
public class StartupOptionsPanel extends javax.swing.JPanel implements OptionsComponent<StartupOptions> {

    private OptionsModifiedListener optionsModifiedListener;
    private final ResourceBundle resourceBundle = App.getModule(LanguageModuleApi.class).getBundle(StartupOptionsPanel.class);
    ...
    public static void main(String[] args) {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.invokeWindow(new StartupOptionsPanel());
        });
    }
