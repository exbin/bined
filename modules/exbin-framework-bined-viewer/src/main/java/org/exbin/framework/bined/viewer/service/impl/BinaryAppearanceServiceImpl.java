 ...
 */
package org.exbin.framework.bined.viewer.service.impl;
...
public class BinaryAppearanceServiceImpl implements BinaryAppearanceService {
    ...
    private final BinedViewerModule binedModule;
    private final EditorProvider editorProvider;

    public BinaryAppearanceServiceImpl(BinedViewerModule binedModule, EditorProvider editorProvider) {
