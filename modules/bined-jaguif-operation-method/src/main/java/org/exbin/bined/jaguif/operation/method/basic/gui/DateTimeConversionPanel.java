...
public class DateTimeConversionPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        byteOrderComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "byteOrder.bigEndian", "byteOrder.littleEndian" }));
        ...
        dataSizeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "dataSize.int32", "dataSize.long64" }));
        ...
        timeUnitLabel.setText(bundle.getString("timeUnitLabel.text")); // NOI18N

        timeUnitComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "timeUnit.seconds", "timeUnit.milliseconds" }));
