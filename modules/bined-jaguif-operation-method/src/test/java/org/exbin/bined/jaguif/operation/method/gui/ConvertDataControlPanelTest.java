...
import org.exbin.bined.jaguif.operation.method.gui.ConvertDataControlPanel;
...
/**
 * Test for ConvertDataControlPanel.
 */
public class ConvertDataControlPanelTest {
    ...
    public void testPanel() {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.wrapInWindow(new ConvertDataControlPanel());
        });
    }
}
