 ...
 */
package org.exbin.bined.jaguif.theme.gui;
...
/**
 * Test for ProfileSelectionPanel.
 */
public class ProfileSelectionPanelTest {
    ...
    public void testPanel() {
        ...
        testApplication.launch(() -> {
            ...
            WindowUtils.wrapInWindow(new ProfileSelectionPanel(new JPanel()));
        });
    }
}
