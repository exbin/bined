 ...
 */
package org.exbin.bined.jaguif.operation.action;
...
public class InsertDataAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        ResourceBundle panelResourceBundle = App.getModule(LanguageModuleApi.class).getResourceBundleByBundleName("org.exbin.bined.jaguif.operation.gui.resources.InsertDataControlPanel");
