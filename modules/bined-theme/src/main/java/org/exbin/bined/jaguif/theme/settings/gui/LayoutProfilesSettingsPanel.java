...
import org.exbin.bined.jaguif.theme.gui.ProfileSelectionPanel;
...
public class LayoutProfilesSettingsPanel extends javax.swing.JPanel implements SettingsComponent {

    protected final java.util.ResourceBundle resourceBundle = App.getModule(LanguageModuleApi.class).getBundle(LayoutProfilesSettingsPanel.class);
