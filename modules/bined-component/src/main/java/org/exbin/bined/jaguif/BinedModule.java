...
import org.exbin.bined.jaguif.action.ShowNonprintablesActions;
import org.exbin.bined.jaguif.action.ViewFontActions;
    ...
    public ViewFontActions getViewFontActions() {
        if (viewFontActions == null) {
            ...
            org.exbin.bined.jaguif.settings.FontSizeOptions fontSizeOptions
                    = new org.exbin.bined.jaguif.settings.FontSizeOptions(optionsModule.getAppOptions());
