...
/**
 * Data size code type actions.
 */
@NullMarked
public class DataSizeCodeTypeActions {

    public static final String DATA_SIZE_CODE_TYPE_RADIO_GROUP_ID = "dataSizenCodeTypeRadioGroup";

    private ResourceBundle resourceBundle;

    public DataSizeCodeTypeActions() {
    }
    ...
    public CursorPositionCodeTypeContribution createDataSizeCodeTypeContribution(PositionCodeType positionCodeType) {
    ...
    public static class OctalPositionCodeTypeAction extends AbstractAction implements ActionContextChange {
        ...
        public void init(ResourceBundle resourceBundle) {
            ...
            putValue(ActionConsts.ACTION_RADIO_GROUP, DATA_SIZE_CODE_TYPE_RADIO_GROUP_ID);
            putValue(ActionConsts.ACTION_CONTEXT_CHANGE, this);
        }

        @Override
        public void actionPerformed(ActionEvent e) {
            DataSizeCodeTypeActions.setPositionCodeType(statusComponent, PositionCodeType.OCTAL);
        }
        ...
        public void updateByContext(BinaryDataSizeComponent context) {
            statusComponent = context;
            boolean hasInstance = context != null;
            if (hasInstance) {
                PositionCodeType positionCodeType = statusComponent.getDataSizeFormat().getCodeType();
    ...
    public static class DecimalPositionCodeTypeAction extends AbstractAction implements ActionContextChange {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            DataSizeCodeTypeActions.setPositionCodeType(statusComponent, PositionCodeType.DECIMAL);
        }
    ...
    public static class HexadecimalPositionCodeTypeAction extends AbstractAction implements ActionContextChange {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
            DataSizeCodeTypeActions.setPositionCodeType(statusComponent, PositionCodeType.HEXADECIMAL);
        }
    ...
    public static void setPositionCodeType(BinaryDataSizeComponent statusComponent, PositionCodeType positionCodeType) {
        statusComponent.setDataSizeCodeType(positionCodeType);
    }
}
