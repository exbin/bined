...
public class LayoutProfilesPanel extends javax.swing.JPanel implements ProfileListPanel {
    ...
    private final java.util.ResourceBundle resourceBundle = App.getModule(LanguageModuleApi.class).getBundle(LayoutProfilesPanel.class);
    ...
    private void initComponents() {
        ...
        previewPanel = new org.exbin.framework.bined.theme.options.gui.PreviewPanel();
...
//        activeOptions = options;
    ...
    private org.exbin.framework.bined.theme.options.gui.PreviewPanel previewPanel;
