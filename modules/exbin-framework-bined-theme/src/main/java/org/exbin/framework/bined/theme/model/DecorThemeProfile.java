...
public class DecorThemeProfile implements ThemeProfile {
    ...
    public DecorThemeProfile(String profileName, SectionCodeAreaThemeProfile themeProfile) {
    ...
    public void copyTo(ThemeProfile targetProfile) {
        ((DecorThemeProfile) targetProfile).profileName = profileName;
        ((DecorThemeProfile) targetProfile).themeProfile = themeProfile;
    }
}
