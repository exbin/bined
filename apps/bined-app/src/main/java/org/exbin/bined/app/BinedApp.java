...
public class BinedApp {
    ...
    public static void main(String[] args) {
        ResourceBundle appBundle = ResourceBundle.getBundle(BinedApp.class.getName(), Locale.ROOT);
        AddonApplication app = AddonApplication.createApplication(BinedApp.class, appBundle);
        App.launch(() -> {
            ...
            app.addModulesFromManifest(BinedApp.class);
            app.initModules();
